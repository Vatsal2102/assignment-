            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1" style="font-size: 1rem;">
                        ...
                        <div><img src="http://localhost/Twin-cities-web-app/Images/sunrise.png" alt="Sunrise" style="width: 16px; height: 16px;"> <span class="ms-1"><?php echo $formattedWeather['sunrise']; ?></span></div>
                    </div>
                    <div>
